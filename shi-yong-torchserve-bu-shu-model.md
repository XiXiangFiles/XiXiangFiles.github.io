...
date: '2020-11-04T19:55:38.000Z'
tags: null
description: >-
  TorchServe 是 PyTorch 提供給開發者部署 models 的工具（實驗階段）。也就是說開發者不用再寫 HTTP 服務去部署，直接使用
  TorchServe 工具就可以了！
---
...
> 2. batchsize 修改方法:
>
>    _curl -v -X PUT "_[http://localhost:8081/models/](http://localhost:8081/models/)_?batch\_size="_
